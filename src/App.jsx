...
return(
    ...
    {restaurants.map((restaurant) => (
      <div key={restaurant.info.id} style={{ border: '1px solid black', margin: '10px', padding: '10px' }}>
        <img style={{ width: '100px', height: 'auto' }} src={`https://media-assets.swiggy.com/swiggy/image/upload/${restaurant.info.cloudinaryImageId}`} alt={restaurant.info.name} />
